...
class AdminOrders extends AdminTab
{
	...
	public function viewDetails()
	{
		...
		echo '
			...
			<?php if ( count( $historyGls ) ) : ?>
				<h2>Historique GLS <small>(<a href="http://www.gls-group.eu/276-I-PORTAL-WEB/dLink.jsp?un=2502824801&pw=surdiscount&crf=<?php echo $order->id; ?>&no=3781001&lc=FR" target="_blank">Voir sur GLS</a>)</small></h2>
				<table cellspacing="0" cellpadding="0" class="table" style="width: 429px">
					<thead>
						<tr>
							<th>Heures</th>
					...
					<tbody>
						<?php foreach ( $historyGls as $i => $item ) : ?>
