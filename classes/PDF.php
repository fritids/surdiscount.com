...
class PDFCore extends PDF_PageGroupCore
{
	...
	*/
	public function Header()
	{
		...
		$conf['PS_SHOP_NAME'] = 'Surdiscount.com';
	...
	*/
	public function Footer()
	{
		...
		if (!self::$delivery)
		{
			...
			$this->Ln(4);
			$this->Cell(0, 10, Tools::iconv('utf-8', self::encoding(), $conf['PS_SHOP_NAME']).' '.self::l('website using your e-mail address and password (which you created when placing your first order).'), 0, 0, 'C', 0, (Configuration::get('PS_SSL_ENABLED') ? 'https://' : 'http://').$_SERVER['SERVER_NAME'].__PS_BASE_URI__.'history.php');
		}
		else
			$this->Ln(4);
		$this->Ln(9);
