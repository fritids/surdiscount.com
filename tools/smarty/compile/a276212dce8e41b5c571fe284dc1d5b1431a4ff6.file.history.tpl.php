<?php /* Smarty version Smarty-3.0.7, created on 2011-08-03 18:02:59
         compiled from "/homepages/13/d194332323/htdocs/www/themes/prestashop/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14065997794e3971336d8483-42718403%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a276212dce8e41b5c571fe284dc1d5b1431a4ff6' => 
    array (
      0 => '/homepages/13/d194332323/htdocs/www/themes/prestashop/history.tpl',
      1 => 1302696061,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14065997794e3971336d8483-42718403',
  'function' => 
  array (
  ),
...
<?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."./account-menu.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
...
<?php }?></td>
				...
				<?php if ((isset($_smarty_tpl->tpl_vars['order']->value['invoice'])&&$_smarty_tpl->tpl_vars['order']->value['invoice']&&isset($_smarty_tpl->tpl_vars['order']->value['invoice_number'])&&$_smarty_tpl->tpl_vars['order']->value['invoice_number'])&&isset($_smarty_tpl->getVariable('invoiceAllowed',null,true,false)->value)&&$_smarty_tpl->getVariable('invoiceAllowed')->value==true){?>
					<a href="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink('pdf-invoice.php');?>
...
<?php if (isset($_smarty_tpl->getVariable('opc',null,true,false)->value)&&$_smarty_tpl->getVariable('opc')->value){?>order-opc<?php }else{ ?>order<?php }?>.php?submitReorder&id_order=<?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
