<?php /* Smarty version Smarty-3.0.7, created on 2011-08-03 17:56:28
         compiled from "/homepages/13/d194332323/htdocs/www/modules/blocksearch/blocksearch-top.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2575288954e396facab26d3-94382245%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcce575931da52360d5fa35934dfa7d2ae83ee21' => 
    array (
      0 => '/homepages/13/d194332323/htdocs/www/modules/blocksearch/blocksearch-top.tpl',
      1 => 1303490956,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2575288954e396facab26d3-94382245',
  'function' => 
  array (
  ),
...
" id="searchbox">
	<p>
		...
		<input class="search_query" type="text" id="search_query" name="search_query" value="<?php if (isset($_GET['search_query'])){?><?php echo stripslashes(htmlentities($_GET['search_query'],$_smarty_tpl->getVariable('ENT_QUOTES')->value,'utf-8'));?>
<?php }?>" /><input type="submit" name="submit_search" value="<?php echo smartyTranslate(array('s'=>'Search','mod'=>'blocksearch'),$_smarty_tpl);?>
" class="button" />
	</p>
	</form>
</div>
...
<?php }?>', {
						minChars: 3,
						max: 10,
						width: $('#search_query').outerWidth(true),
						selectFirst: false,
						scroll: false,
						dataType: "json",
