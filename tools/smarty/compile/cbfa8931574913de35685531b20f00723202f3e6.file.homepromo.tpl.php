<?php /* Smarty version Smarty-3.0.7, created on 2011-08-03 18:02:49
         compiled from "/homepages/13/d194332323/htdocs/www/modules/homepromo/homepromo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10152383624e397129770b51-51721003%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cbfa8931574913de35685531b20f00723202f3e6' => 
    array (
      0 => '/homepages/13/d194332323/htdocs/www/modules/homepromo/homepromo.tpl',
      1 => 1303490442,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10152383624e397129770b51-51721003',
  'function' => 
  array (
  ),
...
<div id="promo-products_block_center" class="block products_block">
	<h4><span class="left"></span><span class="middle"><?php echo smartyTranslate(array('s'=>'Promotions','mod'=>'homepromo'),$_smarty_tpl);?>
	...
	<?php if (isset($_smarty_tpl->getVariable('products',null,true,false)->value)&&$_smarty_tpl->getVariable('products')->value){?>
		<div class="block_content">
			...
			<?php $_smarty_tpl->tpl_vars['nbItemsPerLine'] = new Smarty_variable(6, null, null);?>
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['homePromoProducts']['total'] = $_smarty_tpl->tpl_vars['product']->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['homePromoProducts']['iteration']=0;
if ($_smarty_tpl->tpl_vars['product']->total > 0){
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['homePromoProducts']['first'] = $_smarty_tpl->tpl_vars['product']->first;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['homePromoProducts']['iteration']++;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['homePromoProducts']['last'] = $_smarty_tpl->tpl_vars['product']->last;
?>
					<li class="ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['last']){?>last_item<?php }else{ ?>item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['iteration']%$_smarty_tpl->getVariable('nbItemsPerLine')->value==0){?>last_item_of_line<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['iteration']%$_smarty_tpl->getVariable('nbItemsPerLine')->value==1){?>clear<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['iteration']>($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['total']-($_smarty_tpl->getVariable('smarty')->value['foreach']['homePromoProducts']['total']%$_smarty_tpl->getVariable('nbItemsPerLine')->value))){?>last_line<?php }?>">
...
"><?php echo smartyTranslate(array('s'=>'Voir details'),$_smarty_tpl);?>
	...
	<?php }else{ ?>
		<p><?php echo smartyTranslate(array('s'=>'No promo products','mod'=>'homepromo'),$_smarty_tpl);?>
</p>
	<?php }?>
</div>
<!-- /MODULE Home Promo Products -->
