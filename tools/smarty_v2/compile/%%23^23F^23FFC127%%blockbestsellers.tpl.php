<?php /* Smarty version 2.6.20, created on 2011-03-23 15:04:44
         compiled from /homepages/13/d194332323/htdocs/beta/modules/blockbestsellers/blockbestsellers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homepages/13/d194332323/htdocs/beta/modules/blockbestsellers/blockbestsellers.tpl', 29, false),array('modifier', 'count', '/homepages/13/d194332323/htdocs/beta/modules/blockbestsellers/blockbestsellers.tpl', 31, false),array('modifier', 'escape', '/homepages/13/d194332323/htdocs/beta/modules/blockbestsellers/blockbestsellers.tpl', 33, false),array('modifier', 'strip_tags', '/homepages/13/d194332323/htdocs/beta/modules/blockbestsellers/blockbestsellers.tpl', 38, false),)), $this); ?>
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['best_sellers']['0']['legend'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['best_sellers']['0']['legend'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /></a></li>
			<?php if (count($this->_tpl_vars['best_sellers']) > 1): ?><li><a href="<?php echo $this->_tpl_vars['best_sellers']['1']['link']; ?>
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['best_sellers']['1']['legend'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
" height="<?php echo $this->_tpl_vars['mediumSize']['height']; ?>
" width="<?php echo $this->_tpl_vars['mediumSize']['width']; ?>
" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['best_sellers']['1']['legend'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /></a></li><?php endif; ?>
		</ul>
		<dl>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp, 'UTF-8') : smarty_modifier_strip_tags($_tmp, 'UTF-8')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</a></dt>
