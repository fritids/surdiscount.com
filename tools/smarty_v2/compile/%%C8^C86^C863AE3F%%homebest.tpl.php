<?php /* Smarty version 2.6.20, created on 2011-03-23 15:04:05
         compiled from /homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 3, false),array('function', 'convertPrice', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 18, false),array('modifier', 'count', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 8, false),array('modifier', 'ceil', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 9, false),array('modifier', 'escape', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 14, false),array('modifier', 'truncate', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 27, false),array('modifier', 'intval', '/homepages/13/d194332323/htdocs/beta/modules/homebest/homebest.tpl', 28, false),)), $this); ?>
<!-- MODULE Home Best Products -->
<div id="best-products_block_center" class="block products_block">
	<h4><span class="left"></span><span class="middle"><?php echo smartyTranslate(array('s' => 'Meilleures ventes','mod' => 'homebest'), $this);?>
</span><span class="right"></span></h4>
	<?php if (isset ( $this->_tpl_vars['best_sellers'] ) && $this->_tpl_vars['best_sellers']): ?>
		<div class="block_content">
			<?php $this->assign('liHeight', 203); ?>
			<?php $this->assign('nbItemsPerLine', 3); ?>
			<?php $this->assign('nbLi', count($this->_tpl_vars['best_sellers'])); ?>
			...
			<ul>
			<?php $_from = $this->_tpl_vars['best_sellers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['homeBestProducts'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['homeBestProducts']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['product']):
        $this->_foreach['homeBestProducts']['iteration']++;
?>
				<li class="ajax_block_product <?php if (($this->_foreach['homeBestProducts']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['homeBestProducts']['iteration'] == $this->_foreach['homeBestProducts']['total'])): ?>last_item<?php else: ?>item<?php endif; ?> <?php if ($this->_foreach['homeBestProducts']['iteration']%$this->_tpl_vars['nbItemsPerLine'] == 0): ?>last_item_of_line<?php elseif ($this->_foreach['homeBestProducts']['iteration']%$this->_tpl_vars['nbItemsPerLine'] == 1): ?>clear<?php endif; ?> <?php if ($this->_foreach['homeBestProducts']['iteration'] > ( $this->_foreach['homeBestProducts']['total'] - ( $this->_foreach['homeBestProducts']['total'] % $this->_tpl_vars['nbItemsPerLine'] ) )): ?>last_line<?php endif; ?>">
...
" /></a>
					<div class="action">
						<p class="price">
							...
							<span class="middle"><?php echo Product::convertPrice(array('price' => $this->_tpl_vars['product']['price']), $this);?>
</span>
							<span class="right">
...
"><?php echo smartyTranslate(array('s' => 'Add to cart'), $this);?>
	...
	<?php else: ?>
		<p><?php echo smartyTranslate(array('s' => 'No best products','mod' => 'homebest'), $this);?>
</p>
	<?php endif; ?>
</div>
<!-- /MODULE Home Best Products -->