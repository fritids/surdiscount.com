<?php /* Smarty version 2.6.20, created on 2011-03-23 15:04:05
         compiled from /homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 3, false),array('function', 'convertPrice', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 18, false),array('modifier', 'count', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 8, false),array('modifier', 'ceil', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 9, false),array('modifier', 'escape', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 14, false),array('modifier', 'truncate', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 27, false),array('modifier', 'intval', '/homepages/13/d194332323/htdocs/beta/modules/homelast/homelast.tpl', 28, false),)), $this); ?>
<!-- MODULE Home Last Products -->
<div id="last-products_block_center" class="block products_block">
	<h4><span class="left"></span><span class="middle"><?php echo smartyTranslate(array('s' => 'Nouveautées','mod' => 'homelast'), $this);?>
	...
	<?php if (isset ( $this->_tpl_vars['products'] ) && $this->_tpl_vars['products']): ?>
		<div class="block_content">
			...
			<ul>
			<?php $_from = $this->_tpl_vars['products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['homeLastProducts'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['homeLastProducts']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['product']):
        $this->_foreach['homeLastProducts']['iteration']++;
?>
				<li class="ajax_block_product <?php if (($this->_foreach['homeLastProducts']['iteration'] <= 1)): ?>first_item<?php elseif (($this->_foreach['homeLastProducts']['iteration'] == $this->_foreach['homeLastProducts']['total'])): ?>last_item<?php else: ?>item<?php endif; ?> <?php if ($this->_foreach['homeLastProducts']['iteration']%$this->_tpl_vars['nbItemsPerLine'] == 0): ?>last_item_of_line<?php elseif ($this->_foreach['homeLastProducts']['iteration']%$this->_tpl_vars['nbItemsPerLine'] == 1): ?>clear<?php endif; ?> <?php if ($this->_foreach['homeLastProducts']['iteration'] > ( $this->_foreach['homeLastProducts']['total'] - ( $this->_foreach['homeLastProducts']['total'] % $this->_tpl_vars['nbItemsPerLine'] ) )): ?>last_line<?php endif; ?>">
...
" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
" class="product_image"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['product']['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 58, '...') : smarty_modifier_truncate($_tmp, 58, '...')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html', 'UTF-8') : smarty_modifier_escape($_tmp, 'html', 'UTF-8')); ?>
</a></div>
...
"><?php echo smartyTranslate(array('s' => 'Add to cart'), $this);?>
	...
	<?php else: ?>
		<p><?php echo smartyTranslate(array('s' => 'No last products','mod' => 'homelast'), $this);?>
</p>
	<?php endif; ?>
</div>
<!-- /MODULE Home Last Products -->