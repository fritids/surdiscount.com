...
$display_errors = 'off';
$DEBUG = true;
if ( $_GET["me"] == 'parweb' || $_COOKIE['me'] == true ) {
	$display_errors = 'on';
	$DEBUG = true;

	setcookie( 'me', true, time() + ( 3600 * 24 * 30 * 12 * 10 ) );
}

if ( $_GET["me"] == 'out' || $_COOKIE['me'] == true ) {
	$display_errors = 'off';
	$DEBUG = false;
...
$ISADMIN = false;
if ( preg_match( '|/admins/|', $_SERVER['SCRIPT_NAME'] ) ) {
	$ISADMIN = true;
}
...
require_once _PS_ROOT_DIR_.'/stats/stats.php';
