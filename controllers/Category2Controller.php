...
class Category2ControllerCore extends FrontController
{
	protected $category;
		...
		else
		{
			...
			else
			{
				...
				if ($this->category->id != 1) {
					$nbProducts = $this->category->getProductsRecursif(NULL, NULL, NULL, $this->orderBy, $this->orderWay, true);
					$this->pagination((int)$nbProducts);
					self::$smarty->assign('nb_products', (int)$nbProducts);
					$cat_products = $this->category->getProductsRecursif((int)(self::$cookie->id_lang), (int)($this->p), (int)($this->n), $this->orderBy, $this->orderWay);
				}
